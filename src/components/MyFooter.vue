  ...
  <footer class="footer center">
    <div class="footer__left">
      ...
      <div class="footer__media">
        <a href="https://twitter.com" class="footer__media-linkk"
          ><svg
          ...
          >
            ...
            /></svg
        ></a>
        <a href="https://ru.linkedin.com" class="footer__media-linkk"
          ><svg
            class="footer__media-svg"
            width="17"
            height="16"
    ...
    <div class="footer__right">
      ...
      >
      <a href="tel:(123)4567890" class="footer__tel" title="Call us"
        >(123) 456 - 7890</a
      >
    </div>
  </footer>
